...
float readIR1Cali() {
  ...
  return 7639.679695 / middle - 7.93793942; //8.13793942
}
float readIR2Cali() {
  float arr[20] = {};
  int i;
  ...
  float middle = median(arr, 20);
  return 7245.370852 / middle - 7.259382 ; //7.459382
}
float readIR3Cali() {
  float arr[20] = {};
  int i;
  ...
  float middle = median(arr, 20);
  return  6396.729152 / middle - 6.0674028 ; // 6.4674028
}
float readIR4Cali() {
  float arr[20] = {};
  int i;
  ...
  float middle = median(arr, 20);
  return  5731.640651 / middle - 6.93913476; 
}
float readIR5Cali() {
  float arr[20] = {};
  int i;
